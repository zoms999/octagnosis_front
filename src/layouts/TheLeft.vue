<template>
  ...
  <hr class="w90p" style="border: 1px solid #ffffff; margin: 20px auto; background-color: #ffffff" />
  <div class="copyright">Copyright © 한국진로적성센터. All Rights Reserved.</div>
</template>
...
MenuList.value = [
  ...
  { MenuId: '3', MenuNm: '매니저관리', Lvl: 1, Src: '' },
